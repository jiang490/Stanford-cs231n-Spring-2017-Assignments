...
class ThreeLayerConvNet(object):
    ...
    def __init__(self, input_dim=(3, 32, 32), num_filters=32, filter_size=7,
        ...
        # The pooling layer is fixed, and we have a stride-1 CNN
        cnn_dim = num_filters*(input_dim[1]*input_dim[2]//4)
        self.params["W2"] = weight_scale*np.random.randn(cnn_dim, hidden_dim)
    ...
    def loss(self, X, y=None):
        ...
        # for gradient back flow
        dout, grads["W3"], grads["b3"] = affine_backward(dloss, cache3)
